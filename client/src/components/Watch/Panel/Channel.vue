                            ...
                            <div class="channel__broadcaster">
                                <div class="channel__broadcaster-icon">
                                    <div class="ch-sprite" :chid="channel.id">
                                        <img loading="lazy" decoding="async" :src="`${Utils.api_base_url}/channels/${channel.id}/logo`">
                                    </div>
                                </div>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            // 各タブのスクロール位置を保存するオブジェクト (キー: タブのインデックス / 値: .channels-list-container の scrollTop)
