...
// 新しい Service Worker がアクティブ化した瞬間に全クライアントを制御下に置く
// これにより updateServiceWorker(true) → skipWaiting → reload の流れで確実に新しい SW がページを制御し、
// 古いキャッシュが引き続き使われる状況を防ぐ (旧 generateSW 設定の clientsClaim: true に相当する)
